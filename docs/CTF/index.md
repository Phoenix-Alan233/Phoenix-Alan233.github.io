...
- 校内短学期：[2026 CTF 101](https://ctf.zjusec.net/games/7)（需校网环境）
...
- 看雪论坛，[https://bbs.kanxue.com](https://bbs.kanxue.com)
- ZJU CTF 101 短学期，[https://courses.zjusec.com/slides](https://courses.zjusec.com/slides)
    - 2025 CTF 101 回放，[https://classroom.zju.edu.cn/coursedetail?course_id=72483](https://classroom.zju.edu.cn/coursedetail?course_id=72483)
    - 2026 CTF 101 回放，[https://classroom.zju.edu.cn/coursedetail?course_id=85726](https://classroom.zju.edu.cn/coursedetail?course_id=85726)
...
> 以下均默认竞赛模式为解题模式 Jeopardy。

### 方向

CTF 主要分为 **Misc**（安全杂项）、**Web**（网络攻防）、**Crypto**（密码攻击）、**Pwn**（漏洞利用）、**Reverse**（逆向工程）五大方向，偶尔也会有 **OSINT**（情报搜集）、**Stega**（隐写技术）、**PPC**（算法优化）、**Mobile**（移动安全）、**Blockchain**（区块链安全）等方向。

### 主要赛事

所有赛事可以关注 https://ctftime.org，其中认可度最高的是：

- 强网杯，https://www.qiangwangbei.com
